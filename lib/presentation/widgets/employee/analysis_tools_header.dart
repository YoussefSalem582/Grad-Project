    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'AI-powered tools for emotional analysis',
          ...
          Text(
            'Choose from our comprehensive suite of analysis tools to gain insights into emotional patterns, sentiment trends, and communication effectiveness.',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
